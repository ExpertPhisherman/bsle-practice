...
# Compiler and flags
CC = cc
CFLAGS = -std=gnu11 -Wall -Werror -Wextra -Wpedantic -Wformat=2 -Wstrict-prototypes -Wwrite-strings -Wvla -Wfloat-equal -pthread -D_POSIX_C_SOURCE=200809L -D_DEFAULT_SOURCE
